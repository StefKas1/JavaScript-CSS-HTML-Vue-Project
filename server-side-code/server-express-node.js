...
// MongoDB.
// To use MONGO_DB_CONNECTION; connection string with username and password is in .env file.
...
app.get("/", function (req, res) {
  (async () => {
    try {
      // Connects client to (MongoDB) server.
...
app.listen(port, () => {
  console.log(`If run locally: server listening at http://localhost:${port}`);
});
